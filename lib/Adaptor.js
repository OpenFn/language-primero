    ...
    return new Promise(function (resolve, reject) {
      (0, _request["default"])(params, function (error, response, body) {
        ...
        if (error) {
          ...
          var resp = (0, _Utils.tryJson)(body);
          console.log("".concat(resp.length, " cases retrieved from request: ").concat(JSON.stringify(response.request, null, 2), "."));
          ...
          if (resp.length == 0) {
            ...
            resolve(updateCase(resp[0]._id, {
              data: function data(state) {
                ...
                var oldServices = resp[0].services_section;
